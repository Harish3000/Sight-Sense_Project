    ...
    >
        ...
        <div className="custom-gradient">
          <form onSubmit={Submit}>
            ...
            <div className="mb-2">
              <label className="text" htmlFor="">Clinic Name</label>
              <br />
              <input
                type="text"
            ...
            <div className="mb-2">
              <label className="text" htmlFor="">Location</label>
              <br />
              <input
                type="text"
            ...
            <div className="mb-2">
              <label className="text" htmlFor="" >Contact</label>
              <br />
              <input
                placeholder="Contact Number(Ex:07xxxxxxxx)"
                className="form-conrol"
                type="tel" pattern="^\d{3}\d{4}\d{3}$"
                required
            ...
            <div className="mb-2">
              <label className="text" htmlFor="">Website</label>
              <br />
              <input
                type="text"
